...
<html lang="en">
    ...
    <body>
        ...
        <div class="small-container product-detail">
            <div class="row">
                <div class="col-2">
                    <img src="Pic/Sandwich/Egg/ESandwich03.jpg" width="100%" id="ProductImg">
                </div>
                <div class="col-2">
                    <p>Category : Sandwich = Egg</p>
                    <h1>Salad Egg Sandwich (Multi Gran Bread)</h1>
                    <h4>RM3.50 / Box</h4>
                    <input type="number" value="1">
                    <a href="" class="btn">Add to cart</a>
                    <h3>Products Details<i class="fa fa-indent"></i></h3>
                    <br>
                    <p>1 Box = 2 Cuts.<br>A simple combination of our daily breakfast.</p>
                </div>
            </div>
        </div>
